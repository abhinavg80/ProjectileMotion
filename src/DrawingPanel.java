 ...
 * <p>
 *
Recent features: - save zoomed images (2011/10/25) - window no longer moves
 * when zoom changes (2011/10/25) - grid lines (2011/10/11)
 *
 * @author Marty Stepp
        ...
        implements ActionListener, MouseMotionListener, Runnable, WindowListener
{
    ...
    public void refresh()
    {
        Graphics g = (Graphics2D) imagePanel.getGraphics();
